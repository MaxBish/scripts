...
MY_ORG_ID = ""  # runZero organization ID. See https://console.runzero.com/organizations
WANTED_SITE_NAME = ""  # Name of site within the above Organization. See https://console.runzero.com/sites
MY_INTEGRATION_ID = "" # runZero Integration ID # See https://console.runzero.com/custom-integrations
